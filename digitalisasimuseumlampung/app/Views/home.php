		...
		<div class="row">
			<div class="active-exibition-carusel">
				<div class="single-exibition item">
					<img src="/assets/1/img/e1.jpg" alt="">
					<ul class="tags">
				...
				<div class="single-exibition item">
					<img src="/assets/1/img/e2.jpg" alt="">
					<ul class="tags">
						<li><a href="#">Travel</a></li>
						<li><a href="#">Life style</a></li>
					</ul>
				...
				<div class="single-exibition item">
					<img src="/assets/1/img/e3.jpg" alt="">
					<ul class="tags">
						<li><a href="#">Travel</a></li>
						<li><a href="#">Life style</a></li>
					</ul>
				...
				<div class="single-exibition item">
					<img class="img-fluid" src="/assets/1/img/e2.jpg" alt="">
					<ul class="tags">
						<li><a href="#">Travel</a></li>
						<li><a href="#">Life style</a></li>
					</ul>
				...
				<div class="single-exibition item">
					<img class="img-fluid" src="/assets/1/img/e3.jpg" alt="">
					<ul class="tags">
						<li><a href="#">Travel</a></li>
						<li><a href="#">Life style</a></li>
					</ul>
